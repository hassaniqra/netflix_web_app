        ...
        <footer className="hero">
          ...
          <div className="line_separete">
            <div className="by flex">
                <p style={{display:"flex"}}>Cpoyright <BsCCircle style={{margin:"5px 10px"}}/>2023 - {new Date().getFullYear()} All Rights are Reserved by <Link to="#" style={{marginLeft:"10px"}}></Link></p>
                <div className="icons">
