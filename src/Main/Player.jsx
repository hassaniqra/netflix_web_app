...
export default function Player(){
    ...
    return(
        ...
        <div className="share">
            ...
            <a href={`https://twitter.com/intent/tweet?text=Watch ${Title.split("_").join(" ")} For Free Copy link from and open in new tab&url=`} style={{margin:"0px 0px 0px 20px"}} target="_blank" rel="noreferrer">
                <TwitterIcon size={32} borderRadius={10} />
            </a>
            <a href={`https://api.whatsapp.com/send?text=[${Title.split("_").join(" ")}] [Watch Now For Free or Download in HD]`} borderRadius={10} style={{margin:"0px 0px 0px 20px"}} target="_blank" rel="noreferrer">
            ...
            <a href={`mailto:?subject=${Title.split("_").join(" ")}&body=`} style={{margin:"0px 0px 0px 20px"}} target="_blank" rel="noreferrer">
